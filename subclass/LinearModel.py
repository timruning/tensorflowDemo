...
class LinearModel(training.Model):
    ...
    def __init__(self,
        ...
        Args:
          ...
          activation: Activation function to use.Zhenyu Tan, 1 year ago: • Provide Keras WideDeep Model.
            If you don't specify anything, no activation is applied.
          use_bias: whether to calculate the bias/intercept for this model. If setZhenyu Tan, 2 years ago: • Build
          Keras Linear Model.
