...
def train():
    batch_image, batch_label, batch_lab_name = console.read_and_decode(
        "/data_b/bd-recommend/songfeng/video/lib/cnn/result/train20000.tfrecords", batch_size=4)
        ...
        with tf.device("/gpu:1"):
            ...
            while True:
                try:
                    ...
                    if iter % 200 == 0:
                        label_list = transferNpArray2(label_np, batch_size=4)
                        predict_list = transferNpArray(predict_np, batch_size=4)
                        print(label_list)
                        print(predict_list)
                    ...
                    iter += 1
                    saver.save(session,
                       "/data_b/bd-recommend/songfeng/video/lib/cnn/model/model3/file_name.ckpt")
